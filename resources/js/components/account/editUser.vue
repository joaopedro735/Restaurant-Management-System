<template>
    <v-form ref="form" v-model="valid" lazy-validation>
        ...
        <v-text-field v-model="editingUser.name" :rules="nameRules" label="Name"></v-text-field>
        <v-text-field v-model="editingUser.username" :rules="usernameRules" label="Username"></v-text-field>
        <v-btn :disabled="!valid" @click.prevent="submit">submit</v-btn>
            ...
            submit() {
                if (this.$refs.form.validate()) {
                    ...
                    axios.post("/api/users/me/photo", formData, config).then(response => {
                        ...
                        axios
                            .put("/api/users/me", this.editingUser, config)
                            .then(response => {
