    ...
    <v-dialog v-model="show" @click.stop="show = false" width="600px">
        <v-card>
            ...
            <v-list two-line>
                ...
                <v-list-group v-for="(item, i) in invoiceInfo.items" :key="i" no-action>
                    ...
                    <v-list-tile v-for="subItem in item" :key="subItem.title" @click>
                        <v-list-tile-content>
                            <v-list-tile-title>{{ subItem.name }}</v-list-tile-title>
                            <v-list-tile-sub-title>{{subItem.quantity}} x {{subItem.unit_price}}€
