    ...
    <v-container>
        <v-toolbar @problems="something">
            <v-dialog v-model="dialog" width="500">
                <v-toolbar-title v-show="this.working === true" slot="activator">
                ...
                <v-card>
                    <v-card-title class="headline grey lighten-2" primary-title>Describe your problem</v-card-title>

                    <v-card-text>
                        <v-text-field label="Your problem" v-model="problem"></v-text-field>
                    </v-card-text>
                    ...
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="error" flat @click="notifyManagers(problem)">Notify management</v-btn>
                    </v-card-actions>
                </v-card>
            </v-dialog>
            <v-toolbar-items class="sm-and-down"></v-toolbar-items>
            <v-spacer></v-spacer>
