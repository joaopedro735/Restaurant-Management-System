<template>
    <div>
        <v-card>
            <v-card-title class="headline info white--text" primary-title>Orders
                <v-spacer></v-spacer>
                <v-text-field
            ...
            >
                <template slot="items" slot-scope="props">
                    ...
                    >
                        <td>
                            ...
                            <v-chip
                                    v-if="(props.item.responsible_cook_id === user.id && props.item.state === 'In preparation')"
                                    outline
                                    color="blue darken-1"
                            >
                                <v-avatar>
                            ...
                            <v-chip
                                    v-if="(props.item.responsible_cook_id === user.id && props.item.state === 'Confirmed')"
                                    outline
                            ...
                            <v-chip
                                    v-if="(user.type === 'cook' & props.item.responsible_cook_id === 0)"
                                    outline
                                    color="black"
                            >
                                <v-avatar>
                            ...
                            <v-chip
                                    v-if="(user.type === 'manager' & props.item.responsible_cook_id === 0)"
                                    outline
                                    color="red darken-1"
                            >
                                <v-avatar>
                            ...
                            <v-chip
                                    v-if="(props.item.responsible_cook_id !== user.id && props.item.responsible_cook_id !== 0)"
                                    outline
                                    color="red darken-1"
                            >
                                <v-avatar>
              ...
              <span
                      v-if="props.item.state === 'In preparation' & props.item.responsible_cook_id === user.id & user.type === 'cook'"
              >
                <v-btn
                        small
                        round
                ...
                >
                  <v-icon></v-icon>Prepared
                </v-btn>
              </span>
                            <span
                                    v-if="props.item.responsible_cook_id === user.id & props.item.state === 'Confirmed' & user.type === 'cook'"
                            >
                <v-btn
                        small
                        round
                ...
                <template slot="no-data">
                    <v-alert :value="true" color="info" icon="info">No orders available</v-alert>
                </template>
        ...
        methods: {
            ...
            changeOrderState: function (index, order, state) {
                ...
                if (order.responsible_cook_id !== 0) {
                    axios
                        .put("/api/orders/" + orderToUpdate.id + "?state=" + state)
                        .then(response => {
